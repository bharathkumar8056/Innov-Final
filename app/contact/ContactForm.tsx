...
export default function ContactForm() {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    phoneno: "", // Changed from "phone" to "phoneno" to match EmailJS template
    message: "",
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send("service_33yrlel", "template_qpworcj", {
        ...formData,
    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-y-6">
      <div>
        ...
        <div className="mt-1">
          <input
            ...
            className="py-3 px-4 block w-full shadow-sm focus:ring-green-500 focus:border-green-500 border-gray-300 rounded-md text-black"
          />
        </div>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="mt-1">
          <input
            id="phoneno"
            name="phoneno" // Changed from "phone" to "phoneno" to match EmailJS template
            type="tel"
            autoComplete="tel"
            required
